...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy.setHeightForWidth(self.openInSg.sizePolicy().hasHeightForWidth())
        self.openInSg.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(QtGui.QApplication.translate("Dialog", "All open notes, linked to the current context. Latest changes on top. Green are the Notes linkes to the current Task.", None, QtGui.QApplication.UnicodeUTF8))
